...
E 			: E TK_SOMA E
			{
				if($1.tipo == "float" && $3.tipo == "int")
				{
					...
					aux 		 = $$.label;
					$$.label 	 = converte();
					$$.traducao  = $1.traducao + $3.traducao + "\tfloat " + $$.label + " = " + $1.label + " + " + aux + ";\n";
				...
				else if($1.tipo == "int" && $3.tipo == "float")
				{
					...
					aux 		 = $$.label;
					$$.label 	 = converte();
					$$.traducao  =  $1.traducao + $3.traducao + "\tfloat " + $$.label + " = " + aux + " + " + $3.label + ";\n";
				...
				{	
					$$.tipo 	 = "float";
					$$.label 	 = converte();					
					$$.traducao  = $1.traducao + $3.traducao + "\tfloat " + $$.label + " = " + $1.label + " + " + $3.label + ";\n";
				}
