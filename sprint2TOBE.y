...
E 			: E TK_SOMA E
			...
			{	
				...
				//	cout << "atributos pos 6: " << atributos[6] << endl;
					...
					else if(atributos[4] == "False")
					{
						...
						if(mapaAtual != pilha.mapa.size() - 1)
						{
							$$.traducao  = $3.traducao + "\t" + $$.label + " = " + $3.label + ";\n";
						}
						else{
			...
			{	
				...
				{
					temp = converte();
					pilha.adicionaVariavel($4.label,temp,$4.tipo,"","False");
				}
				else
				{
					temp = atributos[1];
				...
				pilha.adicionaVariavel("",aux1,"int","","True");
				string aux2 = converte();		
				pilha.adicionaVariavel("",aux2,"int","","True");
			...
			{
				vector<string> atributos;
				atributos 	  = pilha.recuperaVariavel($8.label);
				string *label = pilha.recuperaLabel();
...
IMPRIME 	: '(' TK_STR ')'
			...
			{
				vector<string> atributos;
				atributos = pilha.recuperaVariavel($2.label);



				cout << "temp: " << atributos[1] << "\tid: " << atributos[0] << endl;
			...
			| '(' TK_STR ',' E ')'
			{
				if($4.valor == "id")
				{
					...
					atributos 	  = pilha.recuperaVariavel(label[0]);
