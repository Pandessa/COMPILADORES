...
E 			: E TK_SOMA E
			...
			{
				$$.label = converte();
				meuMapa.adicionaVariavel($2.label, $$.label, "int", "", "True");
			...
			{
				$$.label = converte();
				meuMapa.adicionaVariavel($2.label, $$.label, "float", "", "True");
			...
			{
				$$.label = converte();
				meuMapa.adicionaVariavel($2.label, $$.label, "char", "", "True");
			...
			{
				$$.label = converte();
				meuMapa.adicionaVariavel($2.label, $$.label, "boolean", "", "True");
				//$1.traducao = "\tint " + $$.label + ";\n";	
			}
			...
			{			
				...
				else
				{
					...
					else if(atributos[4] == "False")
					{
						...
						//cout<< atributos[0] + " " + atributos[1] + " " + atributos[2];
